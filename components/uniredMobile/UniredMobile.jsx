            ...
            <div className="container relative mt-[67px]">
                ...
                <div className="flex justify-center lg:justify-start md:justify-start">
                    <div className='text-[#1C1C1C]'>
                        <h2 className='text-[24px] leading-[33px] font-[700] tracking-wider opacity-30 font-["Open_Sans"] lg:text-[20px] lg:leading-[30px] md:text-[17px] md:leading-[20px]'>BIZ HAQIMIZDA</h2>
