  ...
  return (
    <section className='mt-[150px] lg:my-[100px] mb-[201px] md:my-[60px]'>
        <div className="container">
            <div>
                <h2 className='text-[24px] leading-[33px] font-[700] tracking-wider opacity-30 font-["Open_Sans"] lg:text-[20px] lg:leading-[30px] md:text-[17px] md:leading-[20px]'>Денежные переводы</h2>
                <h2 className='text-[72px] leading-[98px] font-[700] mt-[20px] mb-[60px] font-["Open_Sans"] lg:text-[60px] lg:leading-[85px] md:text-[50px] md:leading-[80px] md:mb-[40px]'>Денежные переводы из России в Узбекистан</h2>
            </div>
